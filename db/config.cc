...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , enable_keyspace_column_family_estimated_row_count(this, "enable_keyspace_column_family_estimated_row_count", value_status::Used, false, "Enable per keyspace and per column family estimated row count reporting")
